...
export default function PagesIndex({ loaderData }: { loaderData: { pages: Pages[] } }) {
            ...
            <div key={page.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-2">
                  <a href={`/pages/${page.slug}`} className="hover:text-blue-600">
                    {page.title}
                  </a>
                </h2>
                {page.excerpt && (
                ...
                <div className="text-sm text-gray-500">
                  {new Date(page.publishedDate || page.createdAt).toLocaleDateString()}
                </div>
              </div>
            </div>
          ))}
